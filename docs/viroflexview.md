...
A ViroFlexView is a powerful component that allows you to combine many 2D components to create powerful layouts in 3D space. This is achieved by using the power of the flexbox algorithm. More information on flexbox is here. The ViroFlexView supports a subset of flexbox, which can be found here.

Please see our UI Controls & Flexbox guide for more information on using this component.

Layout styles supported for ViroFlexViews can be found here.
...
The width of the ViroFlexView in 3D space. Default is 1.
...
Since ViroFlexView is a 2D container, it can take an array of 1 material that can serve as a background to the entire ViroFlexView.
...
False if the ViroFlexView and it's children should be hidden. By default the ViroFlexView is visible and this value is true.
