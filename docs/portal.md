...
A component that represents the entry way into a PortalScene. A Object3D must be provided with an opacity around [0,0,0] in model coordinates in order for the portal to behave properly.
