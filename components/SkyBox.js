...
var Skybox = createReactClass({
  ...
  render: function() {
    ...
    checkMisnamedProps("Skybox", this.props);
    ...
    nativeProps.onSkyboxLoadStart = this._onLoadStart;
    nativeProps.onSkyboxLoadEnd = this._onLoadEnd;
...
var VRTSkybox = requireNativeComponent(
  'VRTSkybox', Skybox, {
    nativeOnly: {onSkyboxLoadStart: true, onSkyboxLoadEnd: true}
  }
);
