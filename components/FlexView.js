...
var FlexViewPropTypes =  Object.assign(Object.create(PropTypes), {
  backgroundColor: ColorPropType,
});
var stylePropType = StyleSheetPropType(FlexViewPropTypes);
var NativeModules = require('react-native').NativeModules;

/**
 * Used to render a FlexView
 */
var FlexView = createReactClass({
  propTypes: {
    ...View.propTypes,
  ...
  render: function() {
    checkMisnamedProps("FlexView", this.props);
