 ...
 *
 * @providesModule AnimationValidation
 * @flow
 */
'use strict';
...
var AnimationPropTypes = require('./AnimationPropTypes');
...
class AnimationValidation {
  ...
  static validateAnimation(name, animations) {
    ...
    for (var prop in animations[name]) {
      AnimationValidation.validateAnimationProp(prop, name, animations[name], 'AnimationValidation ' + name);
    }
...
AnimationValidation.addValidAnimationPropTypes(AnimationPropTypes);

module.exports = AnimationValidation;
