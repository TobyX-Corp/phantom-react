...
var SceneNavigatorModule = require('react-native').NativeModules.VRTSceneNavigatorModule;
...
/**
 * ##### DEPRECATION WARNING - SceneNavigator may be removed in future releases. Use ViroVRSceneNavigator instead #####
 * SceneNavigator is used to transition between multiple scenes.
 */
var SceneNavigator = createReactClass({
  propTypes: {
    /**
  ...
  async _project(point) {
    return await SceneNavigatorModule.project(findNodeHandle(this), point);
  },

  async _unproject(point) {
    return await SceneNavigatorModule.unproject(findNodeHandle(this), point);
  },

  _recenterTracking() {
    SceneNavigatorModule.recenterTracking(findNodeHandle(this));
  },
  ...
  render: function() {
    ...
    //checkMisnamedProps("SceneNavigator", this.props);

    console.warn("<SceneNavigator> has been DEPRECATED. Please use <VRSceneNavigator> instead.");
...
var VRTSceneNavigator = requireNativeComponent(
    'VRTSceneNavigator', SceneNavigator, {
