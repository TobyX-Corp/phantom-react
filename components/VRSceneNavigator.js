 ...
 *
 * @providesModule VRSceneNavigator
 * @flow
 */
'use strict';
...
/**
 * VRSceneNavigator is used to transition between multiple scenes.
 */
var VRSceneNavigator = createReactClass({
  propTypes: {
    /**
...
module.exports = VRSceneNavigator;
